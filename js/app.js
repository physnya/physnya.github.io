...
import { title } from 'hexo/dist/hexo/default_config';
  ...
  data() {
    return {
      timelineEvents: [
        ...
        { title: '功能', date: '2024-09-03', description: '注册了一个mail.ru免费邮箱账号，修改了 [⌈ 关于 ⌋](https://physnya.top/about/) 页面的邮箱链接.<br>将 [⌈ 动画 ⌋](https://physnya.top/bangumi.html) 页面移至导航栏一级标题 ⌈ 我 ⌋ 之下.' },
